...
\begin{equation*}
	X \sim {B(p)} \quad\Leftrightarrow\quad p(1-p)
\end{equation*}
...
\subsection{Modello uniforme discreto}
...
Come di consueto, integrando nell'intero $\R$ la funzione di densità di probabilità si ottiene $1$:
\begin{equation*}
